                    ...
                    async with aiohttp.ClientSession() as session:
                        async with session.get(url, headers={
                            ...
                            if resp.status == 307:
                                ...
                                # appx CDN domains return 404 — swap to working classx mirror
                                cdn_url = cdn_url.replace('static-db-v2.appx.co.in', 'appx-content-v2.classx.co.in')
                        ...
                        try:
                            ...
                            def _curl_download(dl_url, dest_path):
                                cmd = [
                                    ...
                                    "-H", "Referer: https://lakshyaclasses.appx.co.in/",
                                    "-o", dest_path, dl_url
                                ]
